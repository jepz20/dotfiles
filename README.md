...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/jepz20/dotfiles/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/jepz20/dotfiles/master/install.sh`" -s ask
```
